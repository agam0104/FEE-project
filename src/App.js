...
const Footer = () => {
  return (
    <>
        ...
        <p className="socials"> 
          <a href="https://github.com/agam0104" rel="noreferrer" target="_blank"><VscGithub size={25}/></a>
          <a href="https://instagram.com/_.agamarora._?igshid=OGQ5ZDc2ODk2ZA==" rel="noreferrer" target="_blank"><SiInstagram size={25}/></a>
        </p>
        <p>
            <a href="" rel="noreferrer" target="_blank" className="source">Made By Agam Arora</a> 
        </p> 
